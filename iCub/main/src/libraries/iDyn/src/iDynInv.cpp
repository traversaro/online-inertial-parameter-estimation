...
//~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
Matrix iDynInvSensor::getH_i_s(int i)					const	
{
    if(sens != NULL)
    {
        Matrix H;
        Matrix buf;
        H = sens->getH();
        for(int j = lSens+1; j <= i && j < chain->getN(); j++ ) {
            buf = SE3inv(((*chain)[j]).getH())*H;
            H = buf;
        }
        return H;
    }
...
//~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
const Vector	iDynInvSensor::getAngVel()		const
{
    if(sens != NULL)
        return sens->getAngVel();
    else
    {
        if(verbose)
            fprintf(stderr,"iDynInvSensor error: could not get angular velocity of the FT sensor, because the sensor is not set yet.\n");
        return Vector(0,0.0);
    }
}
//~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
const Vector	iDynInvSensor::getAngAcc()		const
{
    if(sens != NULL)
        return sens->getAngAcc();
    else
    {
        if(verbose)
            fprintf(stderr,"iDynInvSensor error: could not get angular acceleration of the FT sensor, because the sensor is not set yet.\n");
        return Vector(0,0.0);
    }
}
//~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
const Vector	iDynInvSensor::getLinAcc()		const
{
    if(sens != NULL)
        return sens->getLinAcc();
    else
    {
        if(verbose)
            fprintf(stderr,"iDynInvSensor error: could not get linear acceleration of the FT sensor, because the sensor is not set yet.\n");
        return Vector(0,0.0);
    }
}
//~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
const Vector	iDynInvSensor::getLinAccC()	const
{
    if(sens != NULL)
        return sens->getLinAccC();
    else
    {
        if(verbose)
            fprintf(stderr,"iDynInvSensor error: could not get linear acceleration of the center of mass of the second semilink, because the sensor is not set yet.\n");
        return Vector(0,0.0);
    }
}
//~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~

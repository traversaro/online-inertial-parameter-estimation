...
#ifndef LM_MULTITASKLINEARGPRLEARNER__
#define LM_MULTITASKLINEARGPRLEARNER__
 ...
 * \f \epsilon_n \in \mathbb{R}^{m} \f is the output error, subject to the prior \f \mathcal{N}(0,\Sigma_n) \f.
...
class MultiTaskLinearGPRLearner : public IParameterLearner {
private:
    /**
...
public:
     ...
     */
    MultiTaskLinearGPRLearner(unsigned int p = 1, unsigned int m = 1);
    

    /**
     * Copy constructor.
     */
    MultiTaskLinearGPRLearner(const MultiTaskLinearGPRLearner& other);

    /**
     * Destructor.
     */
    virtual ~MultiTaskLinearGPRLearner();

    /**
     * Assignment operator.
     */
    MultiTaskLinearGPRLearner& operator=(const MultiTaskLinearGPRLearner& other);
     ...
     * Inherited from IMachineLearner.
     */
    MultiTaskLinearGPRLearner* clone() {
        return new MultiTaskLinearGPRLearner(*this);
    }

...
/**
 * Pushes a bool to the end of a Bottle using the insertion operator.
 *
 * @param bot  a reference to the bottle
 * @param val  the bool
 * @return a reference to the bottle
 */
yarp::os::Bottle& operator<<(yarp::os::Bottle &out, bool val);
...
/**
 * Pops a bool from the end of a Bottle using the extraction operator.
 *
 * @param bot  a reference to the bottle
 * @param val  a reference to the bool
 * @return  a reference to the bottle
 */
yarp::os::Bottle& operator>>(yarp::os::Bottle &in, bool& val);
